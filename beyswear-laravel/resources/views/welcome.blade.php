...
<div class="hero-fullscreen">
    <div class="hero-content-fix animate-bounce-in">
        ...
        <div style="margin-top: 40px;">
            ...
            <a href="{{ route('login') }}" class="login-karyawan-link">
                Login Karyawan
            </a>
        </div>
    </div>
...
<section class="catalog-section" id="katalog">
    <div class="catalog-header">
        ...
        <p>Booking via WhatsApp, pembayaran dan pengambilan tetap di toko.</p>
    </div>
        ...
        @foreach($produk as $item)
            <div class="catalog-card">
                <div class="catalog-image">
                    ...
                    @else
                        <div class="catalog-no-image">Tidak ada foto</div>
                    @endif
                </div>

                <div class="catalog-content">
                    <span class="catalog-category">{{ $item->kategori }}</span>
                    <h3>{{ $item->nama }}</h3>
